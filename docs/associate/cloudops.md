...
![AWS Certified CloudOps Engineer Associate badge](../assets/images/certifications/cloudops.png){ width="200" loading=lazy }
</div>

<div class="cert-badge-body" markdown>

**AWS Certified CloudOps Engineer Associate** <span class="cert-level cert-level-associate">Associate</span>
...
| Official Page | [AWS CloudOps Engineer Associate](https://aws.amazon.com/certification/certified-sysops-admin-associate/) |
...
- **Official page:** [AWS Certified SysOps Admin Associate](https://aws.amazon.com/certification/certified-sysops-admin-associate/)
- **Exam guide:** [SOA-C02 Exam Guide (PDF)](https://d1.awsstatic.com/training-and-certification/docs-sysops-associate/AWS-Certified-SysOps-Administrator-Associate_Exam-Guide.pdf)
...
[Search Skill Builder for SOA](https://skillbuilder.aws/search?page=1&examCertificationName=AWS+Certified+SysOps+Administrator+-+Associate&price=free&category=learning_plan)
...
[Watch on YouTube](https://youtu.be/QN574SUEP2I)
...
- [AWS Official Practice Questions — 20 free questions](https://skillbuilder.aws/search?page=1&examCertificationName=AWS+Certified+SysOps+Administrator+-+Associate&price=free&searchText=%22official+practice+question+set%22)
...
| Provider | Link | Notes |
|----------|------|-------|
| **AWS Official Practice Exam** | [Skill Builder](https://skillbuilder.aws/search?page=1&examCertificationName=AWS+Certified+SysOps+Administrator+-+Associate&price=subscription_needed&searchText=%22official+practice+exam%22) | Subscription required |
...
| **Neil Davis (Udemy)** | [Udemy Course](https://www.udemy.com/course/aws-certified-sysops-administrator-associate-hands-on/) | |
| **ExamPro** | [exampro.co](https://exampro.co) | 3 exams (1 free, 2 paid) |
| **Whizlabs** | [whizlabs.com](https://www.whizlabs.com/aws-sysops-administrator-associate/) | |
| **QA Learn** | [QA Platform](https://platform.qa.com/learning-paths/sysops-administrator-associate-soa-c02-certification-preparation-for-aws-1-7445/) | Includes learning plan + practice exam |
...
No, labs were removed. Only multiple choice questions.
...
Yes. Most courses teach from scratch.

**Can someone new to IT take this?**
Yes, but be prepared to invest significant time.

**Is coding / shell scripting required?**
No coding required, but basic CLI and shell scripting (Bash / PowerShell) are very helpful. SysOps roles need command line skills.
...
Books go out of date quickly. Not recommended.
...
**Does passing SOA renew Cloud Practitioner (CCP)?**
Yes.

**Does DevOps Professional renew SOA?**
Yes, if unexpired.
